...
1. El usuario hace clic en el enlace de instalación que ha recibido en su dispositivo.

2. Si todavía no tiene instalada la aplicación Outline, se le pide que la descargue y la instale.

3. La aplicación Outline pide automáticamente al usuario que añada tu servidor usando la clave de acceso única insertada en el enlace de invitación.
...
- **Busca la clave:** ve a la página de detalles del servidor en Administrador de Outline e identifica la clave de acceso que corresponda al usuario cuyo acceso quieres revocar.

- **Elimina la clave:** a la derecha de la clave, hay un icono de menú. Haz clic en él y selecciona **Eliminar**.
