...
:::warning[Important]
Mantén el elemento `path` en secreto para evitar comprobaciones. Este elemento actúa como un endpoint secreto. Se recomienda usar una ruta larga y generada de forma aleatoria.
:::
