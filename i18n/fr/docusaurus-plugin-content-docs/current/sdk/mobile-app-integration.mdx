...
Configurez le proxy avec [`OkHttpClient.Builder.proxy`](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-ok-http-client/-builder/proxy.html).
...
:::note
: Utilisez `gomobile bind` sur votre package personnalisé, et pas directement sur les packages du SDK.
:::
