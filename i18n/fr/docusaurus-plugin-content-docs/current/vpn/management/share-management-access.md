...
## Déploiements via des fournisseurs de services cloud
...
#### 1. Accorder l'accès à une équipe
...
### 1. Trouver le fichier `access.txt`
...
### 2. Récupérer la configuration d'accès
...
### 3. Partager la configuration d'accès de façon sécurisée
