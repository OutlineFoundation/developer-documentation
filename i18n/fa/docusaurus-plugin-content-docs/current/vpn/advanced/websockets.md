...
:::note
Shadowsocks-over-WebSockets فقط برای کارخواهان Outline نسخه ۱.۱۵.۰ و بالاتر پشتیبانی می‌شود. باید پیکربندی‌های کنونی‌تان را حفظ کنید تا نسخه‌های قدیمی‌تر کارخواه را پشتیبانی کنید.
:::
...
:::caution
TryCloudflare فقط برای آزمایش و نسخه نمایشی است.
:::
