---
title: "แชร์สิทธิ์เข้าถึงการจัดการกับผู้อื่น"
sidebar_label: "แชร์สิทธิ์เข้าถึงการจัดการกับผู้อื่น"
---
...
## การติดตั้งใช้งานโดยผู้ให้บริการคลาวด์ {#cloud_provider_deployments}
...
#### 1. มอบสิทธิ์การเข้าถึงแก่ทีม {#1_grant_team_access}
...
#### 2. ควบคุมสิทธิ์ {#2_control_permissions}
...
:::tip
สนับสนุนให้ผู้จัดการใหม่เปิดใช้งานการตรวจสอบสิทธิ์แบบหลายปัจจัย (MFA) ในบัญชีของผู้ให้บริการคลาวด์เพื่อการรักษาความปลอดภัยที่ดียิ่งขึ้น
:::

## การติดตั้งด้วยตนเอง {#manual_installations}


:::caution
การแชร์สิทธิ์เข้าถึงการจัดการสำหรับการติดตั้งด้วยตนเองอาจทำให้เกิดความยุ่งยากในการเพิกถอนสิทธิ์เข้าถึงได้ วิธีการที่ตรงไปตรงมาที่สุดคือการติดตั้งเซิร์ฟเวอร์แบบเต็มรูปแบบอีกครั้ง ซึ่งจะสร้างการกำหนดค่าใหม่ แต่ก็รีเซ็ตคีย์การเข้าถึงของผู้ใช้ทั้งหมดออกด้วย
:::
...
### 1. ค้นหาไฟล์ `access.txt` {#1_locate_the_accesstxt_file}
...
### 2. เรียกดูการกำหนดค่าการเข้าถึง {#2_retrieve_the_access_config}
...
:::warning[Important]
บรรทัดนี้มีข้อมูลที่ละเอียดอ่อน โปรดแชร์กับบุคคลที่เชื่อถือได้ซึ่งจำเป็นต้องมีสิทธิ์เข้าถึงการจัดการเท่านั้น
:::

### 3. แชร์การกำหนดค่าการเข้าถึงอย่างปลอดภัย {#3_share_the_access_config_securely}
