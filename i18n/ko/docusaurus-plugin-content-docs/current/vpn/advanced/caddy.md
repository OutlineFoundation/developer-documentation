...
## 1단계: 기본 요건 {#step_1_prerequisites}

- [`xcaddy`](https://github.com/caddyserver/xcaddy)를 다운로드하고 설치합니다.

## 2단계: 도메인 구성 {#step_2_configure_your_domain}
...
## 3단계: 맞춤 Caddy 빌드 구축 및 실행 {#build-and-run}
...
## 6단계: Outline 클라이언트에 연결 {#step_6_connect_with_the_outline_client}
