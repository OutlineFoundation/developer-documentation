...
[`OkHttpClient.Builder.proxy`](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-ok-http-client/-builder/proxy.html)를 사용하여 프록시를 설정합니다.
...
:::note
`gomobile bind` 명령어는 SDK 패키지에 직접 적용하지 말고 맞춤 패키지에 사용하세요.
:::
