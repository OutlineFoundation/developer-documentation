...
Outline SDK를 사용하면 다양한 우회 전략을 지정할 수 있으며, 이러한 전략을 결합하여 다양한 형태의 네트워크 간섭을 우회할 수 있습니다. 이러한 전략의 사양은 [Go 문서](https://pkg.go.dev/github.com/Jigsaw-Code/outline-sdk/x@v0.0.3/configurl)에 있습니다.
...
토론 및 질문은 [Outline SDK 토론 그룹](https://github.com/Jigsaw-Code/outline-sdk/discussions)을 참고하세요.
