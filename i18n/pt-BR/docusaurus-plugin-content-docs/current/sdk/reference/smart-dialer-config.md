...
[documentação de configuração](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Config_Format)
...
- Uma string de configuração `StreamDialer` válida conforme definido em [`configurl`](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Proxy_Protocols) (em inglês).
