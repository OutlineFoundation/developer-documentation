...
do servidor dentro do Outline Manager será aberta. Essa página é sua central para
...
- **Compartilhar a nova chave**: à direita de cada chave, há um ícone de compartilhamento que você
...
1. Em um dispositivo, o usuário clica no link de instalação fornecido.

2. Se o aplicativo Outline não estiver instalado, o usuário deverá fazer o
download e instalar.

3. O aplicativo Outline pede automaticamente que o usuário adicione seu servidor usando a
chave de acesso exclusiva incorporada no link do convite.
...
- **Localize a chave**: vá até a página de detalhes do servidor no Outline Manager
e identifique a chave de acesso correspondente ao usuário que terá o acesso
revogado.

- **Exclua a chave**: à direita da chave, há um ícone de menu. Clique
nele e selecione **Remover**.
