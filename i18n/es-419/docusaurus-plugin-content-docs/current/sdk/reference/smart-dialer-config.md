...
[documentación de configuración](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Config_Format)
...
- Ser una cadena de configuración `StreamDialer` válida, como se define en [`configurl`](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Proxy_Protocols)
