...
:::warning[Important]
No reveles el valor de `path` para evitar sondeos. Actúa como un extremo secreto. Se recomienda una ruta larga y generada aleatoriamente.
:::
