...
## Implementaciones en proveedores de servicios en la nube
...
### 2. Recupera el archivo de configuración de acceso
...
### 3. Comparte el archivo de configuración de acceso de forma segura
