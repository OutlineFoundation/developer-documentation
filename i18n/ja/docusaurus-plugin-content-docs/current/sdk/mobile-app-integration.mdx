...
[`OkHttpClient.Builder.proxy`](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-ok-http-client/-builder/proxy.html) を使用してプロキシを設定します。
...
:::note
`gomobile bind` は、SDK パッケージ上で直接使用するのではなく、カスタム パッケージ上で使用してください。
:::
