...
Установите прокси-сервер с помощью [`OkHttpClient.Builder.proxy`](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-ok-http-client/-builder/proxy.html).
...
:::note
Используйте `gomobile bind` для вашего пакета, а не напрямую для пакетов SDK.
:::
