...
Вставив **конфигурацию доступа** в Менеджер Outline, новый администратор сможет добавить сервер и управлять им через интерфейс приложения. Дополнительную информацию по работе с Менеджером Outline вы найдете в [Справочном центре Outline](https://support.getoutline.org).
