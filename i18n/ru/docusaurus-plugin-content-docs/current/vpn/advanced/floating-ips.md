...
3. Откройте [онлайн-инструмент DNS от Google](https://toolbox.googleapps.com/apps/dig/#A/) и введите свое доменное имя, чтобы узнать, когда вступили в силу изменения на предыдущем шаге.
