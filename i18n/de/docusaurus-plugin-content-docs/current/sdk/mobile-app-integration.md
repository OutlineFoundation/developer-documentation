...
Klonen Sie das Outline SDK Repository:

2. 

Erstellen Sie die Go Mobile-Binärprogramme mit [`go
...
Erstellen Sie Bibliotheken für mobile Apps und fügen Sie diese zu Ihrem Projekt hinzu:
