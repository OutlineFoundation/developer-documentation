...
:::warning[Important]
以下链接是下载 Outline 管理器和 Outline 客户端应用的唯一官方来源。我们并没有通过社交媒体或即时通讯应用（包括 Telegram 和 WhatsApp）来直接发布这些文件。
:::
...
- **Android：**<https://play.google.com/store/apps/details?id=org.outline.android.client>
    ...
    - **备用链接1：**<https://s3.amazonaws.com/outline-releases/client/android/stable/Outline-Client.apk>
