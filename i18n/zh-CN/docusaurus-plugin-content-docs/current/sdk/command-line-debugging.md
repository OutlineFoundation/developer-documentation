...
Outline SDK 允许指定各种规避策略，这些策略可以组合使用，以绕过不同形式的网络干扰。这些策略的规范位于 [Go 文档](https://pkg.go.dev/github.com/Jigsaw-Code/outline-sdk/x@v0.0.3/configurl)中。
...
如需参与讨论和提问，请访问 [Outline SDK 讨论组](https://github.com/Jigsaw-Code/outline-sdk/discussions)。
