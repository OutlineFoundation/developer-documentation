...
### `ss://` bağlantısı kullanma {#use_an_ss_link}
...
### JSON nesnesi kullanma {#use_a_json_object}
...
### YAML nesnesi kullanma {#use_a_yaml_object}
...
## Statik anahtardan erişim bilgilerini ayıklama {#extract_access_information_from_a_static_key}
...
## Barındırma platformu seçme {#choose_a_hosting_platform}
