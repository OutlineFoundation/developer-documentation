...
1. Kullanıcı, cihazında sağlanan yükleme bağlantısını tıklar.

2. Outline uygulaması henüz yüklü değilse kullanıcıdan uygulamayı indirip yüklemesi istenir.

3. Outline uygulaması, otomatik olarak kullanıcıdan sunucunuzu eklemesini ister. Bunun için davetiye bağlantısına yerleştirilen benzersiz erişim anahtarı kullanılır.
...
- **Anahtarı bulma:** Outline Manager'da sunucu ayrıntıları sayfasına gidin ve erişimini iptal etmek istediğiniz kullanıcıya karşılık gelen erişim anahtarını tespit edin.

- **Anahtarı silme:** Anahtarın sağında bir menü simgesi bulunur. Menü simgesini seçip **Kaldır**'ı seçin.
