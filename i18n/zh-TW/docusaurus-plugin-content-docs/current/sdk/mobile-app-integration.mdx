...
使用 [`OkHttpClient.Builder.proxy`](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-ok-http-client/-builder/proxy.html) 設定 Proxy。
...
:::note
請對自訂套件使用 `gomobile bind`，不要直接對 SDK 套件使用。
:::
