...
Outline SDK 可指定各種規避策略，並加以組合，藉此規避不同形式的網路干擾。這些策略的規格位於 [Go 說明文件](https://pkg.go.dev/github.com/Jigsaw-Code/outline-sdk/x@v0.0.3/configurl)中。
...
如要參與討論或提問，請前往 [Outline SDK 討論群組](https://github.com/Jigsaw-Code/outline-sdk/discussions)。
