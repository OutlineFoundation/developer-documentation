...
## 在 DigitalOcean 上建立 Outline 伺服器 {#create_an_outline_server_on_digitalocean}
...
## 設定伺服器的主機名稱 {#make_a_hostname_for_your_server}
...
## 變更伺服器 IP 位址 {#change_the_servers_ip_address}
