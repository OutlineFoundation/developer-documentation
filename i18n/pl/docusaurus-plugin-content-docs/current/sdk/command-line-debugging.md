...
Pakiet SDK Outline umożliwia określanie różnych strategii obchodzenia ograniczeń, które można łączyć, aby omijać różne formy zakłóceń sieci. Specyfikację tych strategii znajdziesz w [dokumentacji Go](https://pkg.go.dev/github.com/Jigsaw-Code/outline-sdk/x@v0.0.3/configurl).
...
Aby wziąć udział w dyskusji lub zadać pytanie, odwiedź [grupę dyskusyjną dotyczącą pakietu SDK Outline](https://github.com/Jigsaw-Code/outline-sdk/discussions).
