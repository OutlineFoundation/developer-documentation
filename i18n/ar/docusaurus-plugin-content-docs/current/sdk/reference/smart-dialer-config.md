...
[مستند الإعدادات](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Config_Format).
...
- سلسلة إعدادات `StreamDialer` صالحة مثل تلك المحدّدة في [`configurl`](https://pkg.go.dev/golang.getoutline.org/sdk/x/configurl#hdr-Proxy_Protocols).
...
:::note
إنّ قاعدة رموز Psiphon مرخَّصة بموجب ترخيص GPL والذي قد يفرض قيودًا على رمزك البرمجي. لذا قد تحتاج إلى الحصول على ترخيص خاص من مطوّري Psiphon.
:::
