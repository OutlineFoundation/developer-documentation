---
title: "إضافة Outline SDK إلى التطبيق على الأجهزة الجوّالة"
sidebar_label: "إضافة Outline SDK إلى التطبيق على الأجهزة الجوّالة"
---
...
([مثال](https://github.com/OutlineFoundation/outline-sdk/blob/master/x/examples/smart-proxy/config.yaml)).
...
Android" ‏(AAR) و"أُطُر عمل Apple" ‏(Apple Frameworks)، على سبيل المثال:
    ...
    - [أرشيف Android من Outline](https://github.com/OutlineFoundation/outline-apps/blob/7058a89530a25a3de376a6ea2d4433a926787f50/client/go/Taskfile.yml#L67-L81)

    - [إطار عمل Apple من Outline](https://github.com/OutlineFoundation/outline-apps/blob/7058a89530a25a3de376a6ea2d4433a926787f50/client/go/Taskfile.yml#L83-L95)
