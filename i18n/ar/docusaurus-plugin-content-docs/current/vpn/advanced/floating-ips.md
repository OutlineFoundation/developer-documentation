...
عيِّن عنوان IP عائمًا إلى Droplet الخاصّ بالخادم.

6. 

غيِّر اسم النطاق ليشير إلى عنوان IP الجديد.
...
انتقِل إلى [Google Domains](https://domains.google.com/m/registrar/) ثمّ
...
غيِّر عنوان IP مثلما سبق، لكن بعنوان IP
عائم جديد. قد يستغرق تنفيذ هذا الإجراء مدّة تصل إلى 48 ساعة، لكن غالبًا ما يتم ذلك خلال
بضع دقائق.

3. 

انتقِل إلى [أداة "نظام أسماء النطاق على الإنترنت" التابعة لـ Google](https://toolbox.googleapps.com/apps/dig/#A/)
